...
import { useState, useLayoutEffect, useCallback, forwardRef, useRef } from 'react';
...
var Loader = function () {
    return (jsxs("div", __assign({ className: "lds-ring" }, { children: [jsx("div", {}, void 0), jsx("div", {}, void 0), jsx("div", {}, void 0), jsx("div", {}, void 0)] }), void 0));
};

var useRipple = function () {
    var _a = useState([]), ripplePosition = _a[0], setRipplePosition = _a[1];
...
var RippleContainer = function (_a) {
    ...
    return (jsx("div", __assign({ className: "absolute inset-0 z-10" }, { children: ripples.length > 0 &&
            ripples.map(function (ripple, index) {
                return (jsx("span", { className: "absolute bg-currentColor rounded-full my-scale-0 animate-ripple", style: {
                        top: ripple.y,
                        left: ripple.x,
                        width: ripple.size,
                        height: ripple.size,
...
var RippleHover = function (_a) {
    ...
    var classes = cn('absolute top-0 left-0 w-full h-full rounded-full ripple-hover', colors[color]);
    return (jsx("div", { className: classes }, void 0));
};
...
var Button = forwardRef(function (props, innerRef) {
    ...
    return (jsxs(Tag, __assign({ ref: mergedRefs, href: href, title: title, role: role, id: id, type: type, className: classes, onClick: handleClick, onMouseEnter: handleMouseEnter, onMouseLeave: onMouseLeave, onMouseDown: onMouseDown, onMouseUp: onMouseUp, onBlur: onBlur, onFocus: onFocus }, { children: [!loading && addonLeft && (jsx("span", __assign({ className: "z-10 mx-1 mr-2" }, { children: addonLeft }), void 0)), !disabled && jsx(RippleHover, { color: color }, void 0), !disabled && jsx(RippleContainer, { ripples: ripplePosition }, void 0), !loading && (jsx("span", __assign({ className: "z-10" }, { children: children }), void 0)), loading && jsx(Loader, {}, void 0), !loading && addonRight && (jsx("span", __assign({ className: "z-10 mx-1 ml-2" }, { children: addonRight }), void 0))] }), void 0));
});
